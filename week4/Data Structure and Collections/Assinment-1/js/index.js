...
$(document).ready(function () {
  ...
  function displayResults(results) {
    var output = JSON.stringify(results.name)
    var height = JSON.stringify(results.height)
    var films = JSON.stringify(results.films)
    resultList.text("name: " + output + ", height: " + height + ", films: " + films);
